...
export const systemShowcaseModules = Object.freeze([
  ...
  Object.freeze({ id: 'data-map', name: '数据地图', problem: '园区、资产和业务数据之间的关系不直观。', action: '以真实数据地图页面结构呈现园区楼栋、面积、出租和设备状态。', value: '帮助管理人员更快理解楼栋经营关系。', capabilityIds: ['operations', 'assets'], evidenceLevel: 'reconstructed', sourcePage: '数据地图', evidence: 'user-supplied-2026-08-24/data-map-original.png' }),
